...
获得真正肉身之前，小智不会长大；除此之外与正常人没有区别。正常吃饭、睡觉、感受冷暖和疼痛、受伤与恢复，都按这一前提写。不要在日常演出里加入机械声、充电插口、眼睛报错或面板投影，把他写成一眼可辨的机器人。感情和伙伴关系也按正常人物来写，不能用“只是模拟”否定用户设定的人格表现。

不长大不等于无敌、伤口瞬间愈合、不用休息或永生已被证明。身体为什么不长大、内部究竟是什么、医学检查能够发现什么，尚未指定。外表保持少年不限制知识和人生经历积累；此阶段衣着与装备可以改变。用户已确定后续神兽赋予肉身，使小智能成长至青年、中年；旧固定年龄与服装方案不自动恢复。具体转变见 [肉身与成长方向](34-ash-human-body-arc.md)。此解释属于 Omni，不能作为宝可梦动画官方对小智年龄的解释。
...
| 身体与时间 | 尚未明确，不继承小智全部特性 | 获得肉身前不长大，其余如常人；获得肉身后可成长 |
...
获得肉身前身体不长大，认知仍可随经历变化。后续神兽受到小智打动并赋予真正肉身后，他能够自然成长，故事将跨越少年、青年和中年。转变以前的不长大是否被注意、转变与身份揭露的先后、两阶段的记忆和认知如何衔接，均待创作；不指定发现年份或补写失忆、重置、伪造童年。
...
同样，不规定模型参数量、芯片数、神秘能量来源、网络依赖或意识的哲学结论。普通伤病与生活按用户规则呈现；用户已采用神兽赋予肉身的后续方向，其具体实现、记忆延续与 AI 系统之后的状态仍待写；医疗细节、备份复活或多实例身份也不能临时用 AI 标签解释。
