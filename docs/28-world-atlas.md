...
2026-09-25 更新：用户明确允许原创全球布局，以不冲突原作已知局部地理为验收标准。现行约定见 [世界地理制作约定](31-world-geography-contract.md)。下列旧图审计保留为历史记录，其中缺乏官方全球位置本身不再构成拒绝新布局的理由。
...
本次没有取得一张覆盖全部目标地区、足以锁定它们全球坐标的官方总图。这不等于证明官方从未发布过任何世界图。暂时未知的关系可以创作为 Omni 设定；需要检查它与已知局部地理相容，而不是证明它是官方设定。
...
2. **全球位置允许原创，局部约束必须保留。** 世界坐标可按 Omni 设计登记，并记录与原作边界、地形及连接的相容性审查。原作相邻和旅行关系逐条保留。新增海域、陆块、交通与距离标为 Omni 内容；无需官方全球位置证明。
