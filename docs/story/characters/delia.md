...
- **1974-04-01 · 少年小智领取皮卡丘**（原型已有／演出未完整）：原型以母亲身份叮嘱小智并提供休息；身份来历未写，她不知小智是 AI。 事件 ID：`ash-departure`。
...
- [小智](ash.md)：原型中的母子称谓；不知小智 AI 身份，不能据此推断生育或秘密共谋。
