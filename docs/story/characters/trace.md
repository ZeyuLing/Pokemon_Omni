...
Let’s Go 劲敌；真新镇同行竞争候选

出生工作年：。

## 人物形象

拟参考动画《宝可梦 进化》第 8 集版本；出场通过社区分集索引定位，尚未逐帧核对和归档。本作少年年龄及服饰未定。
...
Let’s Go 劲敌：Trace／シン

- 官方人物页描述其为玩家邻居，同日从真新镇出发。
- 与游戏青绿和动画小茂分别管理。

证据：官方介绍及社区名称索引。原作资料不自动成为 Omni 已写生平；年龄、比赛履历与政治归属另行采用。

[来源 1](https://www.pokemon.co.jp/ex/pika_vee/character/180713_02.html) · [来源 2](https://bulbapedia.bulbagarden.net/wiki/Trace_(game))

## 劲敌／关联人物提案

友好稳健的同龄对手备选；需与小茂、阿弘在目标和成长经历上作区分。

具体阵营、遇见节点、资格取得与结局未定。[选角研究](../rivals.md)。

## 已写生平

游戏立绘记录：[资产清单](../../../assets/characters/manifest.json)，角色键 `trace`。
