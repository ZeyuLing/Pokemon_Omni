...
研究所开场稿：先与小茂谈自主选择伙伴、八枚徽章和下一步。小茂离开后，才独自开启对战推演终端，并思考为何而战。屏幕不标出测试对象；小茂没有看见测试，也不知秘密。
...
- [坂木](giovanni.md)：昔日冠军对手与研究合作者；当代同求和平联邦，但科技分析与神兽路线分歧，当前联络未定；中间几十年的信任与关系变化需逐段创作，不能预设背叛或决裂。
