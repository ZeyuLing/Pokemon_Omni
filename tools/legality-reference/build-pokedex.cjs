...
const categories=['base','mega','gigantamax','regional','primal_reversion','ultra_burst','tera_related','other_form_review','rocket_bond_candidate','cosmetic','dynamax','battle_state','fusion','gender_form','size_form','type_form','special_form','source_variant'];
const categoryNames=['普通形态','Mega 进化','超极巨化','地区形态','原始回归','究极爆发','太晶特殊形态','其他形态','羁绊形态','外观形态','极巨化','战斗状态','合体形态','性别形态','体型差异','属性形态','特殊形态','改版形态'];
...
require('./ultra-rom-reference.cjs')({root,entries,abilities,stableId,categories});
