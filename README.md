...
新增可播放的战争序章《未竟的和平》、22 人立绘画册和原创 PSG 配乐草稿：[观看序章](http://127.0.0.1:4173/play?opening)、[查看画册](http://127.0.0.1:4173/play?cast)。ROM 标题 L 回放、R 画册；探索 SELECT 切换 1／2／4 倍行走，BGM 由独立硬件计时驱动。任意外部模拟器快进不在原速音乐保证内。角色完整行走／战斗动作仍有未完成项，见 [实际实现与验收边界](docs/36-playable-opening-and-cast.md)。
