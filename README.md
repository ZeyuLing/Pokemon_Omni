...
剧情当前基线见 [战争末期与冠军政治](docs/32-first-journey-world-premise.md)：一周目处于第一次世界大战末期，距红莲事件几十年，年份未定；世界赛与联邦行政权挂钩，小智与赤红的 AI 身份为编剧秘密。下述为早期旅程与技术实现历史，新背景尚未接入 ROM。
...
持续维护的 [世界与人物设定集](docs/story/README.md) 已建立：包含九个现代地区及洗翠的来源地图图册、61 份人物／伙伴档案、23 个正文／已定背景／原型事件。可直接在本地打开 [世界地图](http://127.0.0.1:4180/)、[人物档案](http://127.0.0.1:4180/characters.html)、[世界线](http://127.0.0.1:4180/timeline.html)。未运行时，按设定集文档构建并启动独立本地服务。地图按地区分幅，全球大陆布局尚未定稿；人物未创作的生平保持空白。
