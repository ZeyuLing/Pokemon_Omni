...
持续维护的 [世界与人物设定集](docs/story/README.md) 已建立：包含九个现代地区及洗翠的来源地图图册、60 份人物／伙伴档案、14 个已写或原型事件。可直接在本地打开 [世界地图](http://127.0.0.1:4180/)、[人物档案](http://127.0.0.1:4180/characters.html)、[世界线](http://127.0.0.1:4180/timeline.html)。未运行时，按设定集文档构建并启动独立本地服务。地图按地区分幅，全球大陆布局尚未定稿；人物未创作的生平保持空白。
