...
运行本地服务后打开 **`http://127.0.0.1:4173/play`**。游戏从玩家房间开始，可探索真新镇和镇内建筑、与 NPC 交谈、选择初始伙伴、进行劲敌练习战，并从游戏菜单打开图鉴、队伍、背包和保存。原生 ROM 为 `build/pallet/omni-pallet.gba`（20 MiB），已经通过实际 mGBA 按键流程；操作、构建、共享核心和边界见 [真新镇游戏基础版](docs/14-pallet-town-game.md)。
