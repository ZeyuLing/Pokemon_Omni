...
(async()=>{const browser=await chromium.launch({headless:true,channel:'msedge'});try{
 ...
 for(const mode of ['opening','cast']){
 ...
 assert.deepEqual(errors,[]);console.log('PASS: opening/cast preview links boot real ROM, saved SRAM preserved, cast credits, music/pause toggles, mobile layout');
