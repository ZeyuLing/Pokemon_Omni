...
(function(root){
 ...
 function valid(bytes,maps){
  ...
  for(const base of [0,16384]){
   ...
   const version=v.getUint32(a+4,true),wrapper=v.getUint32(p+4,true),adventureBytes=wrapper===2?140:132,dexAt=16+adventureBytes;
   if(v.getUint32(p,true)!==0x4c41504f||![1,2].includes(wrapper)||v.getUint32(p+12,true)!==n-dexAt||v.getUint32(a,true)!==0x5644414f||![1,2,3].includes(version)||(wrapper===2)!==(version===3)||v.getUint32(a+adventureBytes-4,true)!==hash(a,adventureBytes-4))continue;
   ...
   if(!partyValid||(version===3&&(v.getUint32(a+128,true)>3599999||bytes[a+132]>8)))continue;
